...
| `PUT`  | `/agent/token/agent_root` | `application/json` |
...
[`agent_root`](/docs/agent/options#acl_tokens_agent_root), and
...
| `PUT`  | `/agent/token/acl_agent_root_token` | `application/json` |
...
[`acl_agent_root_token`](/docs/agent/options#acl_agent_root_token_legacy), and
